      ...
      <div className="content">
        ...
        <section className="viewer" aria-label="Lyapunov orbit viewer">
          ...
          {error ? <div className="error" role="alert">{error}</div> : !orbit ? <div className="loading" role="status">Loading trajectory…</div> : <>
            ...
            <dl className="data-strip"><div className="datum"><dt>Energy</dt><dd>{formatEnergy(orbit.metadata.energy)}</dd></div><div className="datum"><dt>Period</dt><dd>{orbit.metadata.period.toFixed(4)}</dd></div><div className="datum"><dt>Family</dt><dd>{orbit.metadata.family_id}</dd></div><div className="datum"><dt>Samples</dt><dd>{orbit.metadata.sample_count}</dd></div></dl>
          </>}
        </section>
